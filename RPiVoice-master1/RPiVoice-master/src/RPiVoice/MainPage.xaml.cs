...
namespace RPiVoice
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        // Bedroom
        private const string TARGET_BOTH = "BOTH";
        // Porch
        ...
        private async void initializeSpeechRecognizer()
        {
...

            {
                ...
                {
                    Debug.WriteLine("Kaboom:", ex.Message);
                }
            }
            else
            {
        ...
        private async void RecognizerResultGenerated(SpeechContinuousRecognitionSession session, SpeechContinuousRecognitionResultGeneratedEventArgs args)
        {
            ...
            Debug.WriteLine("RecognizerResultGenerated:",args.Result.Status);
            Debug.WriteLine("RecognizerResultGenerated:",args.Result.Text);
            ...
            if (device.Equals(DEVICE_LED) || device.Equals(DEVICE_LIGHT))
            {
                ...
                if (target.Equals(COLOR_RED))
                {
                    ...
                    SpeechSynthesisStream synthesisStream = await synthesizer.SynthesizeTextToStreamAsync("The Red Light is" + (isOn ? STATE_ON : STATE_OFF));
                ...
                else if (target.Equals(TARGET_BOTH))
                {
                    Debug.WriteLine("BOTH LIGHTS " + (isOn ? STATE_ON : STATE_OFF));
        ...
        private void WriteGPIOPin(GpioPin pin, GpioPinValue value)
        {
            ...
            pin.Write(value);
            Debug.WriteLine("pin.write:", value);
        }

        private void MainIdentity_press(object sender, Windows.UI.Xaml.RoutedEventArgs e)
        {
            Frame.Navigate(typeof(Mi));
        }
    }
}